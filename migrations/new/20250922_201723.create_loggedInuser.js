migrate(
  (app) => {
    // Creating loggedInUsers collection
    ...
    return app.saveCollection(loggedInUsers)
  },
  (app) => {
    // Dropping loggedInUsers collection
    try {
      const coll = app.findCollectionByNameOrId('loggedInUsers')
