...
export default function EducationInfo({
  ...
  const fields = ['degree', 'institution', 'yearOfPassing', 'grade']
  ...
  return (
    <>
        ...
        {fields.map((field) => (
          <div key={field} className='col-span-1'>
            ...
            <div className='flex items-center space-x-2'>
              <input
                type={field === 'yearOfPassing' ? 'number' : 'text'}
                value={data[field] || ''}
      ...
      <button
        onClick={onNext}
        className='w-full mt-6 px-6 py-2 bg-primaryy text-white rounded-md hover:bg-primaryx'
      >
        Save and Continue
      </button>
    </>
