migrate(
  (db) => {
    ...
    const employees = new Collection({
      id: 'employees000000',
      created: '2025-09-22 13:52:46.724Z',
      updated: '2025-09-22 13:52:46.724Z',
      name: 'employees',
      type: 'base',
      system: false,
      schema: [
    ...
    return dao.saveCollection(employees, verifications)
  },
  (db) => {
    const dao = new Dao(db)

    try {
      const employees = dao.findCollectionByNameOrId('employees000000')
      dao.deleteCollection(employees)
    } catch (e) {}

    try {
      const verifications = dao.findCollectionByNameOrId('verifycoll00000')
      dao.deleteCollection(verifications)
    } catch (e) {}
  }
)
